...
#             # 输入框动画
#             self.input_animation = QPropertyAnimation(self.full_input, b"geometry")
#             self.input_animation.setDuration(500)
...
#     def start_game(self):
#         self.game_window = GameWindow(self.current_user, self.poem)
...
#             self.submit_button.setText("提交")
#             self.switch_language_button.setText("简体中文")
#             self.full_input.setPlaceholderText("請輸入完整句子，這句有{}個字".format(len(self.poem)))
#         else:
#             self.language = 'simplified'
#             self.setWindowTitle("中文诗句填字游戏")
#             self.submit_button.setText("提交")
...
#         conn = sqlite3.connect('poetry_game.db')
#         cursor = conn.cursor()
#         cursor.execute('INSERT INTO user_records (user_id, user_input, correct_guesses, attempts) VALUES (?, ?, ?, ?)',
#                        (self.user_id, user_input, correct_guesses, self.attempt_counter))
#         conn.commit()
#         conn.close()
