...
# from database import create_database, load_poems, load_poems_from_file
# from ui.login_window import PoetryGame
...
#     # 检查诗句是否已加载，如果没有，则从文件导入
#     if not load_poems():
#         try:
#             load_poems_from_file('./poem.txt')
#             print("已成功从poem.txt导入诗句")
